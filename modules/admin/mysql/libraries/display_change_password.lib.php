...
// Displays the form
?>
<form method="post" action="<?php echo $GLOBALS['PMA_SCRIPT_NAME']; ?>" name="chgPassword" onsubmit="return checkPassword(this)">
    <?php   echo PMA_generate_common_hidden_inputs();
            if (strpos($GLOBALS['PMA_SCRIPT_NAME'], 'server_privileges') !== false) {
