...
// To be re-enabled, temp static repertoire and no database creation.
 $repertoire =  "TMD100";
...
// create phpbb 1.4 tables
  ...
  // $langCatagoryMain = dbSanitize($langCatagoryMain);
  ...
  // $langTestForum = dbSanitize($langTestForum);
  // $langDelAdmin = dbSanitize($langDelAdmin);
...
// $langAnonymous = dbSanitize($langAnonymous);
mysql_query("INSERT INTO users VALUES (
               '-1',
               '$langAnonymous',
               NOW(),
...
// Content accueil (homepage) Table
    ...
    // $sbsystems = dbSanitize($sbsystems);
    mysql_query("INSERT INTO accueil VALUES (
               '3',
               '$langDoc',
