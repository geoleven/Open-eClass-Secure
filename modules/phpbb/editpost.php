...
if ($is_adminOfCourse) { // course admin 
	if (isset($submit) && $submit) {
		...
		$nameTools = $langReply;
		$navigation[]= array ("url"=>"index.php", "name"=> $langForums);
		$navigation[]= array ("url"=>"viewforum.php?forum=$forum", "name"=> oSanitize($myrow['forum_name']));
		$navigation[]= array ("url"=>"viewtopic.php?topic=$topic&amp;forum=$forum", "name"=> oSanitize($myrow['topic_title']));
